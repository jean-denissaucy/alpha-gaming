...
const emptyForm = { categoryId: '', gameName: '', link: '', image: '', note: '', releaseYear: '' };
...
export default function AdminDashboard() {
    ...
    const openEdit = (game) => {
        ...
        setForm({ categoryId: String(game.categorie_id ?? ''), gameName: game.game_name || '', link: game.link || '', image: game.image || '', note: game.note != null ? String(game.note) : '', releaseYear: game.release_year != null ? String(game.release_year) : '' });
        ...
        <section className="admin-panel admin-table-panel">
            ...
            <div className="admin-table-wrap">
                <table className="admin-table">
                    <thead>
                        <tr><th>JEU</th><th>CATÉGORIE</th><th>ANNÉE</th><th>NOTE</th><th>LIEN</th><th className="admin-th-actions">ACTIONS</th></tr>
                    </thead>
                    <tbody>
                        {visibleGames.map((game) => (
                            <tr key={game.id}>
                                ...
                                <td>{game.release_year != null
                                    ? <span className="admin-muted">{game.release_year}</span>
            ...
            <div className="admin-modal-backdrop" onClick={closeGameModal}>
                ...
                >
                    ...
                    <form onSubmit={submit} className="admin-form">
                        ...
                        <label>Année de sortie <span>(optionnelle)</span>
                            <input type="number" min="1970" max="2100" value={form.releaseYear} placeholder="Ex : 2026" onChange={(e) => setForm({ ...form, releaseYear: e.target.value })} />
                        </label>
